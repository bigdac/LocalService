...
public class MyJobService extends JobService {
    ...
    public boolean onStartJob(JobParameters params) {
        ...
        boolean isRemoteServiceRun = isServiceRunning(this, HelpService.class.getName());
    ...
    public static void startJob(Context context) {
        ...
        JobInfo.Builder builder = new JobInfo.Builder(10, new
                ComponentName(context.getPackageName(), MyJobService.class.getName())).setPersisted(true);
        if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.N){
            //7.0延迟1s执行
